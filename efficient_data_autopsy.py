...
class EfficientDataAutopsy:
    def __init__(self, data_directory: str = "data", sample_size: int = 10000):
        """
        Initialize the Data Autopsy class with efficient processing for large datasets
        
        Args:
            data_directory: Path to the directory containing CSV files
            sample_size: Number of rows to sample from each large file for analysis
        """
    ...
    def load_all_csv_files(self) -> Dict[str, pd.DataFrame]:
        ...
        For large files, load a sample to enable analysis without memory issues
        """
        ...
        # Load each CSV file (or sample) into a DataFrame
        ...
        # For demonstration purposes, use the first dataframe
...
if __name__ == "__main__":
    ...
    autopsy = EfficientDataAutopsy(data_directory="data", sample_size=10000)
